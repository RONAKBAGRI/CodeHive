...
function ProPlanView() {
  return (
    <div className=" bg-gradient-to-b from-orange-800 to-gray-600">
      <NavigationHeader />
      <div className="relative px-4 h-[80vh] flex items-center justify-center">
        <div className="relative max-w-xl mx-auto text-center">
          ...
          <div className="relative bg-gray-800/60 border border-gray-800/50 backdrop-blur-2xl rounded-2xl p-12">
            ...
            <div className="relative">
              ...
              <p className="text-gray-400 mb-8 text-lg">
                Code with confidence, write with precision.
              </p>

              <Link
                href="/"
                className="inline-flex items-center justify-center gap-2 w-full px-8 py-4 bg-gradient-to-r from-blue-500/10 to-gray-500/10 hover:from-blue-500/20 hover:to-gray-500/20 text-white rounded-xl transition-all duration-200 border border-gray-800 hover:border-gray-500/50 group"
              >
                <Command className="w-5 h-5 text-yellow-200" />
                <span>Open Editor</span>
                <ArrowRight className="w-5 h-5 text-yellow-200 group-hover:translate-x-0.5 transition-transform" />
              </Link>
            </div>
          </div>
        </div>
