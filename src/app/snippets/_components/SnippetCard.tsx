  ...
  return (
    ...
    >
      <Link href={`/snippets/${snippet._id}`} className="h-full block">
        <div
          className="relative h-full bg-gray-800/50 backdrop-blur-sm rounded-xl 
            ...
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-center gap-3">
                <div className="relative">
                  <div
                    className="absolute inset-0 x bg-gradient-to-r from-orange-500/30 to-red-500/30 rounded-lg blur opacity-20 
                  group-hover:opacity-30 transition-all duration-500"
                    area-hidden="true"
                  />
                  <div
                    className="relative p-2 rounded-lg bg-gradient-to-br from-orange-500/10 to-red-500/10 group-hover:from-blue-500/20
                ...
                <div className="space-y-1">
                  <span className="px-3 py-1 bg-blue-500/10 text-blue-300 rounded-lg text-xs font-medium">
                    {snippet.language}
                  </span>
