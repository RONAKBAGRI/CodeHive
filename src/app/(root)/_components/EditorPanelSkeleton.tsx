...
export function OutputPanelSkeleton() {
  return (
    <div className="relative bg-[#2e271e] rounded-xl p-4 ring-1 ring-gray-800/50">
      {/* Header */}
      ...
      <div className="relative">
        ...
        <div className="relative bg-[#2e271e]/50 backdrop-blur-sm border border-[#313244] rounded-xl p-4 h-[600px]">
